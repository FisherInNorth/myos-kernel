...
extern uchar inittest[]; //new init for testcard
extern int sizeofinittest;
...
uchar initcode[] = {
  ...
  0x93, 0x08, 0x70, 0x00, 0x73, 0x00, 0x00, 0x00,
  0x93, 0x08, 0x20, 0x00, 0x73, 0x00, 0x00, 0x00,
  0xef, 0xf0, 0x9f, 0xff, 0x2f, 0x62, 0x75, 0x73,
  0x79, 0x62, 0x6f, 0x78, 0x00, 0x00, 0x24, 0x00,
...
userinit(void)
{
  ...
  // and data into it.
  uvminit(p->pagetable , p->kpagetable, inittest, sizeofinittest);
  p->sz = PGSIZE;
  ...
  safestrcpy(p->name, "inittest", sizeof(p->name));
